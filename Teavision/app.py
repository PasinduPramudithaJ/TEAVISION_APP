...
def extract_features_api():
    ...
    try:
        ...
        subject="Your Tea Vision Analysis Results Are Ready",
        message_text=f"""Dear User,

We are pleased to inform you that your Tea Vision analysis has been successfully completed.

Please find the detailed analysis results attached to this email as a CSV file:
File Name: {output_csv_name}

The attached file contains the extracted features and prediction results generated by the Tea Vision system.

If you have any questions regarding the results or require further assistance, please feel free to reply to this email.

Thank you for using Tea Vision.

Best regards,  
Tea Vision Team  
TeaQNet Application  
teaqnetapp@gmail.com
""",
